export type Membership = 'BRONZE' | 'SILVER' | 'GOLD' | 'DIAMOND';
...
export type keyType = keyof AdvancedSearch;
export const keys = ['firstName', 'lastName', 'middleName', 'id', 'isMember', 'sex', 'club'] as keyType[];
